package com.example.restaurant.cleanArchitecture.presentration.adapter
...
class ShopListAdapter : RecyclerView.Adapter<ShopViewHolder>
{
    ...
    constructor(context: Context, items: ArrayList<Shop>, listener: ShopListItemListener)  {
        this.itemList = items
...
class ShopViewHolder(private val itemBinding: ItemShopBinding,
                     private val listener: ShopListAdapter.ShopListItemListener) :
